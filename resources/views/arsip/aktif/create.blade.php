...
@section('title', 'Registrasi Arsip Aktif')
...
<div class="main-container">
    <main class="content-area px-6 pt-2 pb-0 space-y-4">
        <div class="bg-white rounded-xl p-6 shadow-md max-w-5xl mx-auto w-full">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>Belum ada data arsip aktif yang terinput sebelumnya.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('arsip.aktif.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <textarea name="uraian_isi" rows="5"
                        placeholder="diisi dengan isi masalah arsip yang diinput"
                ...
                <div>
                    ...
                    <input type="text" name="berkas" required
                        placeholder="diisi dengan jumlah arsip, contoh: 1 berkas dll"
                        class="w-full px-4 py-2 border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="tanggal" required
                        placeholder="diisi dengan tanggal bulan tahun/tahun saja/TT jika tanpa tahun"
                        class="w-full px-4 py-2 border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="lokasi_simpan" required
                        placeholder="diisi dengan lokasi penyimpanan fisik arsip"
                        class="w-full px-4 py-2 border border-slate-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
...
document.querySelector("form").addEventListener("submit", async function(e) {
    ...
    try {
        const res = await fetch("{{ route('api.cek_nomor_arsip_aktif') }}", {
            method: "POST",
            headers: {
