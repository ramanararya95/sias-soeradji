<!-- resources/views/laporan/aktivitas/index.blade.php -->
@extends('layouts.app')

@section('title', 'Laporan Aktivitas - SIAS Soeradji')

@section('header-title', 'Laporan Aktivitas')
@section('header-subtitle', 'Cetak Laporan Data Aktivitas')

@section('content')
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-6">Filter Laporan Aktivitas</h2>
    
    <form action="{{ route('laporan.aktivitas.filter') }}" method="POST" class="space-y-4">
        @csrf
